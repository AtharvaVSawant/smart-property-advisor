...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            # ✅ FINAL FIX (robust target handling)
            if "MEDV" in train_df.columns:
                target_column_name = "MEDV"
            else:
                raise Exception("Target column MEDV not found in dataset")
        ...
        print("TARGET COLUMN BEING USED:", target_column_name)